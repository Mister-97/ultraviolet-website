          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2px", marginTop: "2px" }}>
            {placeholders.map((p) => (
              <div
                ...
                style={{ aspectRatio: "16/9", backgroundColor: "#0d0d0d", border: "1px solid rgba(214,196,148,0.08)" }}
              >
                <div className="w-12 h-px mb-4" style={{ backgroundColor: "rgba(214,196,148,0.3)" }} />
                <p className="font-display text-2xl tracking-widest mb-2" style={{ color: "rgba(245,240,232,0.2)" }}>{p.title}</p>
                <p className="font-body text-xs tracking-[0.4em] uppercase" style={{ color: "rgba(214,196,148,0.3)" }}>{p.desc}</p>
                <div className="w-12 h-px mt-4" style={{ backgroundColor: "rgba(214,196,148,0.3)" }} />
              </div>
            ))}
          </div>
